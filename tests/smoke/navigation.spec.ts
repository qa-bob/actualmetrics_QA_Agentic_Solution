...
test.describe('Navigation', () => {
  ...
  test('Navigation: Angelfish menu link navigates correctly', async ({ homePage }) => {
  ...
  test('Navigation: Urchin menu link navigates correctly', async ({ homePage }) => {
    await homePage.nav.navigateToUrchIn();
    await assertPagePath(homePage.page, 'urchin-software');
  });

  test('Navigation: Google Analytics Alternative link navigates correctly', async ({ homePage }) => {
    await homePage.nav.googleAnalyticsAltLink.click();
    await assertPagePath(homePage.page, 'google-analytics-alternative');
  });

  test('Navigation: Consulting sub-menu link navigates correctly', async ({ homePage }) => {
    await homePage.nav.navigateToConsulting();
    await assertPagePath(homePage.page, 'services/consulting');
  });

  test('Navigation: About Us sub-menu link navigates correctly', async ({ homePage }) => {
